...
const TesMinatIntro = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50/50 py-24 px-6 md:px-12 flex flex-col items-center">
            {/* Simple Navbar */}
            ...
            <div className="max-w-3xl w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="text-center space-y-4">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">
                        Tes Minat & Bakat <span className="text-blue-700">Cekadu</span>
                    </h1>
                ...
                <div className="bg-white rounded-3xl border border-gray-100 shadow-xl shadow-blue-900/5 overflow-hidden">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="flex gap-4 items-center">
                                    ...
                                    <span className="text-sm font-bold text-gray-700">Skor 6 Kategori Minat</span>
                                </div>
                                <div className="flex gap-4 items-center">
                                    <div className="p-3 bg-blue-50 text-blue-700 rounded-xl">
                                        <Target size={24} />
                                    </div>
                                    <span className="text-sm font-bold text-gray-700">3 Tipe Kepribadian Dominan</span>
                                </div>
                                <div className="flex gap-4 items-center">
                                    <div className="p-3 bg-blue-50 text-blue-700 rounded-xl">
                                        <ClipboardList size={24} />
                                    </div>
                                    <span className="text-sm font-bold text-gray-700">Rekomendasi Jurusan Relevan</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-gray-50 p-8 flex flex-col items-center">
                        <button
                            ...
                            className="bg-blue-700 hover:bg-blue-800 text-white px-12 py-5 rounded-2xl font-extrabold text-xl shadow-xl shadow-blue-700/20 transform hover:-translate-y-1 transition-all active:scale-95"
                        >
                            Mulai Tes Sekarang
                        </button>
                        <p className="mt-4 text-gray-400 text-xs font-medium">Bebas biaya & Tanpa Login</p>
                    </div>
                </div>
            </div>
        </div>
